  ...
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7" />
      ...
      <div className={isOpen ? "block" : "hidden"}>
        <div className="px-2 pt-2 pb-3 sm:ml-2">
          <Link href="#explore">
            <a className="block px-4 py-2 mt-1 text-base font-semibold transition duration-150 ease-in-out focus:outline-none focus:text-white">
              Explore
            </a>
          </Link>

          <Link href="#live-help">
            <a className="block px-4 py-2 mt-1 text-base font-semibold transition duration-150 ease-in-out rounded-lg hover:text-white focus:outline-none focus:text-white">
              {" "}
              Live help{" "}
            </a>
          </Link>
          ...
          <Link href="#about">
            <a className="block px-4 py-2 mt-1 text-base font-semibold transition duration-150 ease-in-out bg-white rounded-lg hover:opacity-75 focus:outline-none focus:opacity-75">
              {" "}
              About
            </a>
          </Link>
          ...
          <Link href="#faq">
            <a className="block px-4 py-2 mt-1 text-base font-bold transition duration-150 ease-in-out bg-white rounded-lg hover:opacity-75 focus:outline-none focus:opacity-75">
              {" "}
              FAQ
            </a>
          </Link>
